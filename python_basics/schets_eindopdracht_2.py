...
def play_sequence(choice):
    if choice in lists:
        ...
        random_list1 = [random.uniform(0.45, 0.99) for _ in chosen_list]
        random_list2 = [random.uniform(0.45, 0.99) for _ in chosen_list]
        random_list3 = [random.uniform(0.45, 0.99) for _ in chosen_list]
        random_list4 = [random.uniform(0.45, 0.99) for _ in chosen_list]
        ...
        multiplied_list1 = [round(x * r3, 2) for x, r3 in zip(chosen_list, random_list3)]
        multiplied_list2 = [round(x * r4, 2) for x, r4 in zip(chosen_list, random_list4)]
        ...
        combined_notes = []
        for t1, t2 in zip(time_list1, time_list2):
